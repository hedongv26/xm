            ...
            <div slot="content" class="list-item-body-content">
              <div class="list-item-row">
                <div class="list-item-row-l">
                  <div>{{titles.create_uid}}</div>
                </div>
                <div class="list-item-row-r">{{item.create_uid}}</div>
              </div>
              <div class="list-item-row">
                <div class="list-item-row-l">
              ...
              <div class="list-item-row">
                <div class="list-item-row-l">
                  <div class="justify-4">{{titles.investors}}</div>

                </div>
                <div class="list-item-row-r" v-html="doEmptyStr(item.investors)"></div>
              </div>
              <div class="list-item-row">
                <div class="list-item-row-l">
                  <div class="justify-4">国(省)别</div>

                </div>
                <div class="list-item-row-r" v-html="doEmptyStr(item.region)"></div>
              </div>
              <div class="list-item-row">
                <div class="list-item-row-l">
              ...
              <div class="list-item-row">
                <div class="list-item-row-l">
                  <div>{{titles.area_id}}</div>
                </div>
                <div class="list-item-row-r" v-html="doEmptyStr(getAreaTitle(item.area_id))"></div>
              </div>
              <collapse-transition>
                <div class="item-more" v-show="item.show_more&&item.show_more===true">
                  <div class="list-item-row">
                    ...
                    <div class="list-item-row-r">{{item.overview}}</div>
                  </div>
                  <div class="list-item-row">
                    <div class="list-item-row-l">
      ...
      <popup v-model="show_filter" class="filter-p-div" position="right"
        ...
        <div class="filter-div">
          <div class="checker-box">
            ...
            <checker v-model="filter['progress']" default-item-class="checker-item"
          ...
          <div class="checker-box">
            ...
            <checker v-model="filter['investment_mode']" default-item-class="checker-item"
                     selected-item-class="checker-item-selected">
          ...
          <div class="checker-box">
            ...
            <checker v-model="filter['industry']" default-item-class="checker-item"
                     selected-item-class="checker-item-selected">
          ...
          <div class="checker-box">
            <div class="checker-title" v-if="checkRole('index/index')">{{titles.area_id}}：</div>
...
<script>
  import { getIndex, getList, getProgressList } from '@/api/bureau'
  ...
  export default {
    ...
    activated () {
      ...
      this.$store.dispatch('GetHaveUpdated', 'bureau').then(val => {
        // 如果更新了数据
        if (val === true) {
